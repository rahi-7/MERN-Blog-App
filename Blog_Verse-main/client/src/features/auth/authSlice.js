...
// Reset Password resets the user's password using a token and a new password.
...
// Activate Account
// activates a user's account using a token. The authToken is retrieved from the current state.
...
// Set Custom Auth
//A custom action to manually set authentication details.
...
export const authSlice = createSlice({
    ...
    reducers: {
        authReset: (state) => {
//Resets the authentication state to its initial values, reloading the user from localStorage.
    ...
    //Handles the state changes for each asynchronous thunk action.
...
//The use of createAsyncThunk and extraReducers allows for clear and manageable state transitions,
