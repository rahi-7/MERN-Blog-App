import React, { Fragment } from 'react' //For building and structuring the component.
import { useDispatch, useSelector } from 'react-redux'; // Hooks from react-redux for interacting with the Redux store.
import { Link, useNavigate } from 'react-router-dom';// From react-router-dom for navigation within the app.
import { toast } from 'react-toastify';//For displaying notifications.
import { Icon, Label, Grid, Button } from 'semantic-ui-react';//For UI elements
import { extractDescriptionFromHTML, formatDate } from '../app/helpers';//Helper functions: extractDescriptionFromHTML and formatDate are utility functions used to format blog content and dates.
